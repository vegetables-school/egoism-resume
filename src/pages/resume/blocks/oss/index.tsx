const Oss = () => {
  return <div>
     <div fic gap-2 mt-5>
      <div class="text-5" i-fluent-mdl2:open-source></div>
      <h3 m-0>开源经历</h3>
    </div>
    <hr/>
    <h4 m0 fic>tdesign-vue-next（开源贡献者）<img src="https://img.shields.io/github/stars/Tencent/tdesign-vue-next" /></h4>
    <h5 m0>
      PRs:
    ...
    <h4 m0 fic>水墨UI（核心开发者之一）<img src="https://img.shields.io/github/stars/shuimo-design/shuimo-ui" /></h4>
    <ul m0>
      <li>负责shuimoUI中多个Vue版本组件的开发以及维护；</li>
      <li>推动shuimoUI覆盖Web Component/Vue/React三大场景；</li>
    </ul>

    <h4 m0>极客江湖（核心开发者之一）（进行中）</h4>
    <ul m0>
