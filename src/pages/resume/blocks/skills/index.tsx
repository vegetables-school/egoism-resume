    ...
    <hr />
      ...
      <ul m0>
        ...
        <li>熟悉主流框架Vue2/3及其部分原理，熟悉Vue周边生态，熟悉Vue-Router、Vuex、Pinia等技术栈的使用，能够使用Vue +
          TypeScript完成日常需求，能够熟练的封装公共组件，抽象公共库方法；
        </li>
        <li>了解Git基本命令行的使用，有开源库PR/MR经历，在TDesign开源项目中提交过多个PR；</li>
        <li>了解Eslint/Prettier基本配置，有良好的编码习惯，对不规范的代码容忍度低；</li>
      ...
      <ul m0>
        ...
        <li>了解Java，能够读懂基本的Java代码；</li>
        <li>开发流程：熟悉JetBrain全家桶，熟悉Nginx，熟悉MarkDown，了解k8s、docker；</li>
      </ul>
  </div>
}
